...
```tsx
<WingGrid transformations={['P', 'IN', 'CO', 'DE', 'RE', 'SY']} columns={3} animate />
```
...
```tsx
<WingAnimation sequence={['P', 'IN', 'CO', 'DE', 'RE', 'SY']} interval={1000} />
```

### Complete Showcase

```tsx
<WingShowcase title="HUMMBL Transformations" showAllTransformations />
```
