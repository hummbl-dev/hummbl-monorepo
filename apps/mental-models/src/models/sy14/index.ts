...
const DEFAULT_CONFIG: Required<SY14Config> = {
  id: 'sy14',
  name: 'SY14 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY14 Synthesis Model
 */
export const createSY14Model = (config: Partial<SY14Config> = {}) => {
