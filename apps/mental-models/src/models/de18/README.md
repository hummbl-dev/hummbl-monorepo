...
```typescript
import { createDE18Model } from '@hummbl/models/de18';

// Create an instance of the model
const model = createDE18Model({
...
### createDE18Model(config?)

Creates a new instance of the DE18 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'DE18')
