...
const DEFAULT_CONFIG: Required<SY07Config> = {
  id: 'sy07',
  name: 'SY07 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY07 Synthesis Model
 */
export const createSY07Model = (config: Partial<SY07Config> = {}) => {
