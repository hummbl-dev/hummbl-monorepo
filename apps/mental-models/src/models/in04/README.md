...
```typescript
import { createIN04Model } from '@hummbl/models/in04';

// Create an instance of the model
const model = createIN04Model({
...
### createIN04Model(config?)

Creates a new instance of the IN04 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'IN04')
