...
const DEFAULT_CONFIG: Required<SY09Config> = {
  id: 'sy09',
  name: 'SY09 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY09 Synthesis Model
 */
export const createSY09Model = (config: Partial<SY09Config> = {}) => {
