...
export interface P5CompleteEvent {
  requestId: string;
  result: P5Output;
  timestamp: string;
}
...
export type P5EventHandler = (event: P5CompleteEvent | P5ErrorEvent) => void;