...
const DEFAULT_CONFIG: Required<SY20Config> = {
  id: 'sy20',
  name: 'SY20 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY20 Synthesis Model
 */
export const createSY20Model = (config: Partial<SY20Config> = {}) => {
