...
const DEFAULT_CONFIG: Required<SY13Config> = {
  id: 'sy13',
  name: 'SY13 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY13 Synthesis Model
 */
export const createSY13Model = (config: Partial<SY13Config> = {}) => {
