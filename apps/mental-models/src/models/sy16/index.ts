...
const DEFAULT_CONFIG: Required<SY16Config> = {
  id: 'sy16',
  name: 'SY16 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY16 Synthesis Model
 */
export const createSY16Model = (config: Partial<SY16Config> = {}) => {
