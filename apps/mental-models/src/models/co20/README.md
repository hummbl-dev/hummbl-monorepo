...
```typescript
import { createCO20Model } from '@hummbl/models/co20';

// Create an instance of the model
const model = createCO20Model({
...
### createCO20Model(config?)

Creates a new instance of the CO20 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'CO20')
