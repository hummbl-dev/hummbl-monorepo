...
```typescript
import { createIN17Model } from '@hummbl/models/in17';
...
### createIN17Model(config?)

Creates a new instance of the IN17 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'IN17')
