 ...
 */
export const createDE16Model = (config: Partial<DeconstructionConfig> = {}) => {
  ...
  const analyze = async (input: DeconstructionInput): Promise<DeconstructionOutput> => {
    ...
    try {
      ...
      if (typeof input.system === 'object' && !Array.isArray(input.system)) {
        ...
        components.push(
          ...Object.keys(input.system).map((key) => ({
            id: key,
        ...
        analysis: {
          ...
          insights: [
            ...
            relationships.length > 0
              ? 'Identified ' + relationships.length + ' relationships'
                  ...
                  typeof input.system === 'string'
                    ...
                    : Array.isArray(input.system)
                      ...
                      : typeof input.system === 'object'
                        ? Object.keys(input.system).length
                        : 1,
              }
            : undefined,
        },
...
export default createDE16Model;
