...
export interface P6CompleteEvent {
  requestId: string;
  result: P6Output;
  timestamp: string;
}
...
export type P6EventHandler = (event: P6CompleteEvent | P6ErrorEvent) => void;