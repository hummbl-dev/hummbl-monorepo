...
export interface P16CompleteEvent {
  requestId: string;
  result: P16Output;
  timestamp: string;
}
...
export interface P16ErrorEvent {
  requestId: string;
  error: string;
  timestamp: string;
}
...
export type P16EventHandler = (event: P16CompleteEvent | P16ErrorEvent) => void;