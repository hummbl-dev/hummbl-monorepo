...
export const IN2_CONSTANTS = {
  ...
  ERROR_PATTERNS: [
    // Syntax errors
    {
      ...
      suggestion:
        'Review the syntax in the specified location and correct any errors. Ensure all brackets, parentheses, and quotes are properly closed.',
    },
    ...
    // Network errors
    {
      ...
      severity: ErrorSeverity.HIGH,
      suggestion:
        'Check your network connection and ensure the server is running and accessible. Verify API endpoints and authentication if applicable.',
    },

    // Authentication errors
    {
      pattern:
        /(401 Unauthorized|403 Forbidden|Invalid credentials|Authentication failed|Invalid token)/i,
      category: ErrorCategory.AUTHENTICATION,
      severity: ErrorSeverity.HIGH,
      suggestion:
        'Verify your authentication credentials and ensure you have the necessary permissions. Check if your session has expired.',
    },

    // Resource not found
    {
      pattern:
        /(404 Not Found|Resource not found|Cannot GET|Cannot read property '.*' of undefined)/i,
      category: ErrorCategory.DATA,
      severity: ErrorSeverity.MEDIUM,
      suggestion:
        'The requested resource could not be found. Verify the resource ID or path is correct and the resource exists.',
    },
    ...
    // Validation errors
    {
      ...
      severity: ErrorSeverity.MEDIUM,
      suggestion:
        'Please check your input and ensure all required fields are provided in the correct format.',
    },
    ...
    // Timeout errors
    {
      ...
      severity: ErrorSeverity.MEDIUM,
      suggestion:
        'The operation took too long to complete. Please try again later or check if the server is under heavy load.',
    },
    ...
    // Rate limiting
    {
      ...
      severity: ErrorSeverity.MEDIUM,
      suggestion:
        'You have exceeded the allowed request rate. Please wait before making additional requests or consider implementing rate limiting in your application.',
    },
    ...
    // Resource exhaustion
    {
      ...
      severity: ErrorSeverity.HIGH,
      suggestion:
        'The system is running low on resources. Close unused applications, increase system resources, or optimize memory usage in your application.',
    },
    ...
    // Deprecation warnings
    {
      ...
      suggestion:
        'This feature or API is deprecated. Please update your code to use the recommended alternative.',
    },
    ...
    // Performance warnings
    {
      ...
      severity: ErrorSeverity.MEDIUM,
      suggestion:
        'Performance issues detected. Consider optimizing the operation or query for better efficiency.',
    },
  ],
  ...
  EXAMPLE_SCENARIO: {
    ...
    description:
      'The system is experiencing an increased rate of 500 errors from the payment processing API.',
    errors: [
      {
