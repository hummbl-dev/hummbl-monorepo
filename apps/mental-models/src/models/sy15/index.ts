...
const DEFAULT_CONFIG: Required<SY15Config> = {
  id: 'sy15',
  name: 'SY15 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY15 Synthesis Model
 */
export const createSY15Model = (config: Partial<SY15Config> = {}) => {
