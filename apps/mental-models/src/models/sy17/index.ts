...
const DEFAULT_CONFIG: Required<SY17Config> = {
  id: 'sy17',
  name: 'SY17 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY17 Synthesis Model
 */
export const createSY17Model = (config: Partial<SY17Config> = {}) => {
