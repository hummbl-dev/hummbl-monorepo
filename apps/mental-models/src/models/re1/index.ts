 ...
 */
export function createIterativeRefinement<T>(config: RefinementConfig<T>): {
  refine: () => Promise<RefinementResult<T>>;
 ...
 */
function determineStopReason<T>(
  state: RefinementState<T>
): 'max_iterations' | 'no_improvement' | 'error' {
