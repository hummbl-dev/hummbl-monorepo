...
```typescript
import { createDE15Model } from '@hummbl/models/de15';

// Create an instance of the model
const model = createDE15Model({
...
### createDE15Model(config?)

Creates a new instance of the DE15 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'DE15')
