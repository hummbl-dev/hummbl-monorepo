...
const DEFAULT_CONFIG: Required<SY19Config> = {
  id: 'sy19',
  name: 'SY19 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY19 Synthesis Model
 */
export const createSY19Model = (config: Partial<SY19Config> = {}) => {
