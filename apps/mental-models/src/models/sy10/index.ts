...
const DEFAULT_CONFIG: Required<SY10Config> = {
  id: 'sy10',
  name: 'SY10 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY10 Synthesis Model
 */
export const createSY10Model = (config: Partial<SY10Config> = {}) => {
