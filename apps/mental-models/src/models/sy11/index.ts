...
const DEFAULT_CONFIG: Required<SY11Config> = {
  id: 'sy11',
  name: 'SY11 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY11 Synthesis Model
 */
export const createSY11Model = (config: Partial<SY11Config> = {}) => {
