...
```typescript
import { createIN18Model } from '@hummbl/models/in18';
...
### createIN18Model(config?)

Creates a new instance of the IN18 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'IN18')
