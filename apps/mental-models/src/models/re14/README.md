...
```typescript
import { createRE14Model } from '@hummbl/models/re14';

// Create an instance of the model
const model = createRE14Model({
...
### createRE14Model(config?)

Creates a new instance of the RE14 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'RE14')
