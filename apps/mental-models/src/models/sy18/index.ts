...
const DEFAULT_CONFIG: Required<SY18Config> = {
  id: 'sy18',
...
/**
 * Creates a new instance of the SY18 Synthesis Model
 */
export const createSY18Model = (config: Partial<SY18Config> = {}) => {
