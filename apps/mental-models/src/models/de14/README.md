...
```typescript
import { createDE14Model } from '@hummbl/models/de14';

// Create an instance of the model
const model = createDE14Model({
...
### createDE14Model(config?)

Creates a new instance of the DE14 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'DE14')
