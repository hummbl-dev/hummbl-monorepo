...
```typescript
import { createDE17Model } from '@hummbl/models/de17';

// Create an instance of the model
const model = createDE17Model({
...
### createDE17Model(config?)

Creates a new instance of the DE17 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'DE17')
