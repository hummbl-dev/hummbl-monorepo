...
const DEFAULT_CONFIG: Required<SY08Config> = {
  id: 'sy08',
  name: 'SY08 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY08 Synthesis Model
 */
export const createSY08Model = (config: Partial<SY08Config> = {}) => {
