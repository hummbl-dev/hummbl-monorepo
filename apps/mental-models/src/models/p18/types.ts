...
export interface P18CompleteEvent {
  requestId: string;
  result: P18Output;
  timestamp: string;
}
...
export interface P18ErrorEvent {
  requestId: string;
  error: string;
  timestamp: string;
}
...
export type P18EventHandler = (event: P18CompleteEvent | P18ErrorEvent) => void;