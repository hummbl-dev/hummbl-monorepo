...
```typescript
import { createCO14Model } from '@hummbl/models/co14';

// Create an instance of the model
const model = createCO14Model({
...
### createCO14Model(config?)

Creates a new instance of the CO14 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'CO14')
