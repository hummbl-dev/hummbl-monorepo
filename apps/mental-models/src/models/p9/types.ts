...
export interface P9CompleteEvent {
  requestId: string;
  result: P9Output;
  timestamp: string;
}
...
export type P9EventHandler = (event: P9CompleteEvent | P9ErrorEvent) => void;
