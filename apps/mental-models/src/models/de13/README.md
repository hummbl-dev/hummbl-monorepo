...
```typescript
import { createDE13Model } from '@hummbl/models/de13';

// Create an instance of the model
const model = createDE13Model({
...
### createDE13Model(config?)

Creates a new instance of the DE13 model.

**Parameters:**
- `config` (Optional): Configuration object
  - `name` (string): Name of the model instance (default: 'DE13')
