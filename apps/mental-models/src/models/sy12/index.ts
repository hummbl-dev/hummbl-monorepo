...
const DEFAULT_CONFIG: Required<SY12Config> = {
  id: 'sy12',
  name: 'SY12 Synthesis Model',
  version: '1.0.0',
...
/**
 * Creates a new instance of the SY12 Synthesis Model
 */
export const createSY12Model = (config: Partial<SY12Config> = {}) => {
