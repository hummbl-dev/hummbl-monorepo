...
export interface P20CompleteEvent {
  requestId: string;
  result: P20Output;
  timestamp: string;
}
...
export interface P20ErrorEvent {
  requestId: string;
  error: string;
  timestamp: string;
}
...
export type P20EventHandler = (event: P20CompleteEvent | P20ErrorEvent) => void;