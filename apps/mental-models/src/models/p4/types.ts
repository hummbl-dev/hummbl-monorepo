...
export interface P4CompleteEvent {
  requestId: string;
  result: P4Output;
  timestamp: string;
}
...
export type P4EventHandler = (event: P4CompleteEvent | P4ErrorEvent) => void;