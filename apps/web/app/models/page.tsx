    ...
    <div className="min-h-screen py-12 bg-black">
      ...
      <div className="mb-12 py-12 text-center border-b border-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-neutral-400 max-w-2xl mx-auto">
            Explore {models.length} {transformationFilter ? TRANSFORMATIONS[transformationFilter].name : ''} mental models
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-12">
          <Link
            href="/models"
            className={`px-5 py-2 rounded-full text-sm font-bold transition-all border ${!transformationFilter
          ...
          {Object.values(TRANSFORMATIONS).map((t) => (
            <Link
              ...
              className={`px-5 py-2 rounded-full text-sm font-bold transition-all border ${transformationFilter === t.code
            ...
            >
              <div className="h-full p-6 bg-black border border-neutral-800 hover:border-white transition-colors">
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className={`px-2.5 py-1 rounded text-xs font-bold ${getPriorityClasses(model.priority)}`}>
                    {model.code}
                  </div>
                  <span
                    className="px-2.5 py-1 rounded bg-black text-neutral-400 text-xs font-bold border border-neutral-800"
                  >
